package com.example.ifarm.weather.activities;
...
import com.example.ifarm.weather.AlarmReceiver;
import com.example.ifarm.weather.Constants;
import com.example.ifarm.weather.adapters.ViewPagerAdapter;
import com.example.ifarm.weather.adapters.WeatherRecyclerAdapter;
import com.example.ifarm.weather.fragments.AboutDialogFragment;
import com.example.ifarm.weather.fragments.AmbiguousLocationDialogFragment;
import com.example.ifarm.weather.fragments.RecyclerViewFragment;
import com.example.ifarm.weather.models.Weather;
import com.example.ifarm.weather.tasks.GenericRequestTask;
import com.example.ifarm.weather.tasks.ParseResult;
import com.example.ifarm.weather.tasks.TaskOutput;
import com.example.ifarm.weather.utils.Formatting;
import com.example.ifarm.weather.utils.UI;
import com.example.ifarm.weather.utils.UnitConvertor;
import com.example.ifarm.weather.widgets.AbstractWidgetProvider;
import com.example.ifarm.weather.widgets.DashClockWeatherExtension;
...
import static com.example.ifarm.weather.utils.TimeUtils.isDayTime;
...
public class MainActivity extends BaseActivity implements LocationListener {
    ...
    protected void onDestroy() {
        ...
        boolean flag =false;
        if (!flag){
            TextView Temper = (TextView) findViewById(R.id.todayTemperature);
            String city =todayWeather.getCity();
            String namevalue=Temper.getText().toString();
            ...
            String a = getIntent().getStringExtra("id1");
            intent.putExtra("id",a);
            overridePendingTransition(0,0);
            startActivity(intent);
            menuActivity.fa.overridePendingTransition(0,0);
